...
<body>
    ...
    <div align="center">
        ...
        <center>
                <a href="inputstatus.php">+ Tambah Status</a>
        <center>
        <form method="post" action="caristatus(admin).php">
      ...
      ?> <tr>
                ...
                <td bgcolor="#99FFFF" style="text-align: center;">
                    <a href="editstatus.php?idpegawai=<?php echo $data['idpegawai'];?>" class="edit">Edit</a>
                    <a href="deletestatus.php?idpegawai=<?php echo $data['idpegawai'];?>" class="delete" onclick="return confirm('Yakin menghapus data?');">Hapus</a>
                </td>
            </tr>
            <?php  } ?>
        </table>
